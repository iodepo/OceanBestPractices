...
{
  var HOSTED_VIEWER_ORIGINS = ['s3.amazonaws.com'];
...
var PDFFindBar = function () {
  function PDFFindBar(options) {
    ...
    // Add phraseSearch UI capability
    // Via https://github.com/mozilla/pdf.js/pull/7870/files
    ...
    this.phraseSearch.addEventListener('click', function() {
      _this.dispatchEvent('phrasechange');
    });
